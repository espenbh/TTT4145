...
switch N_feature
    case 1  %Klasse to og tre er tredje vanskeligst å skille fra hverandre ved klasse 4
        x_training=[x1all(1:D,3);...
                    x2all(1:D,3);...
                    x3all(1:D,3)];
        
        x_test=    [x1all(D+1:N,3);...
                    x2all(D+1:N,3);...
                    x3all(D+1:N,3)];
    case 2  %Klasse to og tre er nest vanskelist å skille fra hverandre ved feature 1
    ...
    case 3  %Klasse to og tre er vanskeligst å skille fra hverandre ved feature 2.
...
% 1D scatter
% scatter(x2all(:,3), ones(1,N))
% hold on
% scatter(x3all(:,3), ones(1,N))
